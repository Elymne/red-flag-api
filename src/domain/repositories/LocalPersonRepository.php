...
interface LocalPersonRepository
{
     ...
     * @return Person[]
     */
    function findMany(string|null $firstname = null, string|null $lastname = null, int|null $birthday = null, string|null $jobname = null, string|null $zonename = null): array;
